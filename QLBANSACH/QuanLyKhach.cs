...
namespace QLBANSACH
{
    public partial class QuanLyKhach : UserControl
    {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            int maMoi = dtKhachHang.AsEnumerable()
                .Select(r =>
                {
                    int x;
                    int.TryParse(r["MaKhachHang"].ToString(), out x);
                    return x;
                })
                .DefaultIfEmpty(0)
                .Max() + 1;
        ...
        private void dgvKhachHang_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            int ma = Convert.ToInt32(
                dgvKhachHang.Rows[e.RowIndex].Cells["MaKhachHang"].Value
            );

            if (dtHoaDon.AsEnumerable().Any(r =>
            int.TryParse(r["MaKhachHang"].ToString(), out int mkh) && mkh == ma))
            {
            ...
            string xPath = $"/KhachHangData/KhachHang[MaKhachHang='{ma}']";
